...
const siteConfig = {
  title: "Shaojie's channel", // Title for your website.
  tagline: "Shaojie's channel for testing",
  ...
  headerLinks: [
    {doc: 'docker/installation', label: 'Docs'},
    {doc: 'doc4', label: 'API'},
